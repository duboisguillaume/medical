		...
		<div class="container bloc blocPatients">
			...
			<table class="table">
				...
				<tr>
					...
					<td> <a href="deletePatient?id=${patient.id}" class="btn btn-danger btn-sm"><i class="fas fa-times"></i> </a> </td>
		...
		<div class="container bloc blocInfirmieres">
			...
			<table class="table">
				...
				<tr>
					...
					<td> <a href="deleteInfirmiere?id=${infirmiere.id}" class="btn btn-danger btn-sm"><i class="fas fa-times"></i></a> </td>
